const CACHE_NAME = "brightwood-pwa-local209";
const CORE_FILES = [
  "./",
  "./index.html",
  "./updates.html",
  ...
  "./styles.css?build=local209",
  "./games.js?build=local209",
  "./difficulty-levels.js?build=local209",
  "./expanded-question-banks.js?build=local209",
  "./app.js?build=local209",
