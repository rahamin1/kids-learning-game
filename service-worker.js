const CACHE_NAME = "brightwood-pwa-0.1.47";
const CORE_FILES = [
  "./",
  "./index.html",
  "./updates.html",
  ...
  "./styles.css?build=0.1.47",
  "./games.js?build=0.1.47",
  "./difficulty-levels.js?build=0.1.47",
  "./expanded-question-banks.js?build=0.1.47",
  "./app.js?build=0.1.47",
  "./manifest.webmanifest?v=0.1.47",
