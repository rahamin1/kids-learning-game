const CACHE_NAME = "brightwood-pwa-test036";
const CORE_FILES = [
  "./",
  "./index.html",
  "./updates.html",
  "./remove-updates.html",
  "./styles.css?build=test036",
  "./games.js?build=test036",
  "./difficulty-levels.js?build=test036",`n  "./app.js?build=test036",
  "./manifest.test.webmanifest?v=0.1.33-test",
