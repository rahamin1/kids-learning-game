  ...
  function natureQuestions(kind,level){
    ...
    if(kind==="foodChain"){
      const basic=[
        ...
        ["צוף","פרפר","עכביש","ציפור","מפרקים"],["אצות","דגיגים","דג גדול","כלב ים","מפרקים"],["עשב","אייל","אריה","מפרקים","אדמה"],["זרעים","עכבר","שועל","נשר","מפרקים"],["אצות","קריל","פינגווין","כלב ים","מפרקים"],
        ["אצות","קריל","דג קטן","דג גדול","מפרקים"],["עשב","ארנב","ינשוף","נשר","מפרקים"],["עלים","זחל","ציפור שיר","ינשוף","מפרקים"],["פרחים","כנימה","פרת משה רבנו","דרור","מפרקים"],["פירות","חרק","לטאה","נחש","מפרקים"]
      ];
      const simplePairs=[
        ...
        ["עלים","חלזון"],["עשב","עכביש"],["צוף","פרפר"],["אצות","דגיגים"],["גרגרים","דרור"],["אצות","קריל"],
        ["עשב ים","צב ים"],["עלי בר","ארנב"],["קליפת עץ","זחל"],["פרחים","כנימה"],["פירות","קוף"],["נקטאר","פרפר"]
      ];
      const advanced=[
        ["אצות","זואופלנקטון","דגיג","טונה","כריש"],["אצות","קריל","פינגווין","כלב ים","לווייתן קטלן"],["עשב ים","חלזון ים","סרטן","תמנון","כריש"],["אצות","שרימפס","דג קטן","דולפין","כריש"],["אצות","קריל","דג קטן","דג גדול","מפרקים"],
