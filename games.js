  ...
  function natureQuestions(kind,level){
    ...
    if(kind==="causeEffect"){
      const rows=[
        ...
        ["השאירו את הכביסה בחוץ בזמן הגשם","הכביסה נרטבה",["הכביסה התייבשה לגמרי","הכביסה התחממה מאוד","הכביסה התקפלה מעצמה"],["הכניסו את הכביסה הביתה לפני הגשם","תלו את הכביסה בתוך הבית","ייבשו את הכביסה במייבש"],"בבוקר הכביסה הייתה יבשה. אחר כך ירד גשם, וכשחזרו הביתה היא הייתה רטובה"],
        ...
        ["העיפו עפיפון ביום עם רוח","העפיפון עלה לשמיים",["העפיפון שקע במים","העפיפון קפא","העפיפון הפך לכדור"],["קרעו את העפיפון","הניחו את העפיפון על הרצפה","קיפלו את העפיפון"],"העפיפון היה גבוה מעל הראש"],
        ...
        ["שמו חלב במקרר","החלב נשאר קר",["החלב התחמם","החלב קפא מיד","החלב הפך למיץ"],["השאירו את החלב בשמש","שמו את החלב ליד תנור","הניחו את החלב בארון"],"כשמזגו את החלב הוא היה קר"],
      ...
      const closeCauses=[
        ...
        ["הכניסו את הכביסה הביתה לפני הגשם","תלו את הכביסה בתוך הבית","ייבשו את הכביסה במייבש"],
        ...
        ["קרעו את העפיפון","הניחו את העפיפון על הרצפה","קיפלו את העפיפון"],
        ...
        ["השאירו את החלב בשמש","שמו את החלב ליד תנור","הניחו את החלב בארון"],
